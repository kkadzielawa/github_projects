...
def main():
	...
	my_random_list_of_lists = random_nums_list_generator(1,100,9,100) #generate a list of 9 floats, will be assigned to a1,a2 etc respectiveliy
	...
	numberss = real_count_looper(final_list)
...
def real_count_looper(final_list):
...
def final_printout(final_list):
	...
	for i in range(len(final_list)):
		print "For the set of paramaters of:",final_list[i][0:9], "we get",final_list[i][9],"real solution(s)!"
