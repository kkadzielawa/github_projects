...
def main():
	...
	solution_list = return_solns()

	#print solution_list

	y = convert_str2dict(solution_list)
...
def return_solns():
	...
	a1,a2,a3,b2,b3,c3 = 0.92891395772098839, 1.303566079211365, 0.76044272231152932, 0.92660020733093262, 0.62429718773639498, 0.76267095502706472
	r1 = .5
	r2 = .5
	r3 = .5
